...
export class AdoptionComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.petService.getPetById(targetId).subscribe({
      ...
      error: (e) => {
        console.log('Error returned at ngOnInit() in adoption.component.ts:32');
      },
    });
      ...
      next: (data) => {
        ...
        console.log(
          'Successfully returned user ' +
            this.adopter.nickname +
            ' from username ' +
            username
        );
      },
      error: (e) => {
        console.log('Error returned at ngOnInit() in adoption.component.ts:40');
      },
    });
  }
  ...
  createRequest(): void {
    ...
    this.requestService
      .postRequestAdoption(pr, 22, pr.c_id, pr.p_id)
      .subscribe({
        next: (data) => {
          pr = data;
        ...
        error: (e) => {
          console.log(
            'Error returned at ngOnInit() in adoption.component.ts:77'
          );
        },
      });
  }
